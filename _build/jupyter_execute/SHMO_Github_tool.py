...
# # HückelSolver
# 
# Never reinvent the wheel. I am willing to bet that every *Python* program that you plan to make has **already** already been written. Randal Taylor has **written** a *Python* class library that provides tools for **calculating** parameters of SHMO systems. The code can be obtained [here](https://github.com/randlet/SHMO)
# 
...
# 
# When you call the class function, you **create** an object with that class (it has all the properties of the class). This is the heart of "**object oriented programming**". We don't care about that, we're just goint to use it.
# 
